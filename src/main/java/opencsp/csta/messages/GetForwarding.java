...
public class GetForwarding extends CSTARequest implements CSTAXmlSerializable {
    ...
    public GetForwarding(String xmlBody) {
        ...
        if(devices.getLength() == 1) {
            ...
            Log.e(TAG, "GetForwarding MUST contain one device.");
        }
    }
}
